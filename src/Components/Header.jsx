...
const Header = () => {
  ...
  return (
    <div>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 fixed z-20 w-full px-4 md:p-0">
        <div className="container mx-auto">
          <div className="flex flex-wrap flex-col md:flex-row justify-between items-center max-w-screen-2xl py-4 ">
            <Link
              to="/"
            ...
            <div className="flex items-center space-x-6 rtl:space-x-reverse">
              ...
              <span
                ...
                className="bi bi-search text-slate-500 dark:text-white  text-xl"
              ></span>
